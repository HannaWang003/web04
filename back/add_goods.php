<h1 class="ct">新增商品</h1>
<form action="./api/add_goods.php?do=goods" method="post" enctype="multipart/form-data">
    <table class="all">
        <tr>
        ...
        <tr>
            <td colspan="2" class="ct"><input type="submit" value="新增"><input type="reset" value="重置"><input
